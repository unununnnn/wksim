...
2026-09-08纠正：下文“e1链一致”和“需R2024b环境”的推断被新的原始元数据核对修正。e1 SLX实际保存于R2017b，R2024b只是ZIP生成器版本；相同revision不证明其pixhawk外链库身份一致。e0噪声种子也已有更精确核对，见[数值合同就绪报告](2026-09-08-numerical-contract-readiness.md)。以下保留历史，不能再作为这些旧结论的当前依据。
