...
root=pathlib.Path.cwd();p=root/'validation/spin-cpu-mixed-20260913-02'
...
bash tools/run-joint-flight.sh \
 ...
 2>&1 | tee validation/spin-cpu-mixed-20260913-02/run.stdout.log
formal_exit=${PIPESTATUS[0]}
printf '%s\n' "$formal_exit" > validation/spin-cpu-mixed-20260913-02/exit-code.txt
exit "$formal_exit"
