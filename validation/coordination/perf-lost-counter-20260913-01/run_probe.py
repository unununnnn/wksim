...
paths=[root/'lost_counter_probe.c']
...
for name,raw in out.get('raw_files',{}).items():(capture/name).write_bytes(base64.b64decode(raw))
print(json.dumps({k:v for k,v in out.items() if k!='raw_files'}))
