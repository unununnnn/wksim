...
root=pathlib.Path.cwd();p=root/'validation/parent-probe-run-20260913-01'
...
bash tools/run-joint-flight.sh \
 ...
 2>&1 | tee validation/parent-probe-run-20260913-01/run.stdout.log
formal_exit=${PIPESTATUS[0]}
printf '%s\n' "$formal_exit" > validation/parent-probe-run-20260913-01/exit-code.txt
exit "$formal_exit"
