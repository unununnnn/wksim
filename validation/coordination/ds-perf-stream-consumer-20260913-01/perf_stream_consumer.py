    ...
    try:
        ...
        report = dict(
            ...
            stream_completeness_reason=(
                'the pending LOST check at stop is not yet specified in the contract, so a clean '
                'decode plus collector_complete=true does not prove the stream is lossless; LOST '
                'records that fell outside the retained bytes cannot be seen from here'),
            pairs=pairs,
