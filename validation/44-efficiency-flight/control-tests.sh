...
exec /usr/bin/python3 -B -m unittest validation.test_rc_control validation.test_rc_input validation.test_rc_transport validation.test_control_operation_clock validation.test_scene_lease validation.test_prometheus_native validation.test_control_takeoff_settle -v
