...
def main():
    contract = json.loads((ROOT / 'docs/plan/full-contracts/model-07-vtol.json').read_text(encoding="utf-8"))
    ...
    assert 'vtol' not in (ROOT / 'Simulator/wksim_core/model_parameters.py').read_text(encoding='utf-8').lower()
