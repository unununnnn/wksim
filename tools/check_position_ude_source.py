...
FROZEN_PROTOCOL_SHA256 = "52d106448a01e0e4460a50f12a0a513f5ca822f77cad1b56fa66b4d102fc93b2"
CPP = r'''
#include <Eigen/Eigen>
#include <iostream>
#include <iomanip>
...
def run(evidence):
    ...
    try:
        if hashlib.sha256(raw).hexdigest() != FROZEN_PROTOCOL_SHA256:
            raise ValueError("fixed protocol identity changed")
        identities = {}
